...
As it transpires from the second table, there is no significant correlation between the two variables. High life expectancy is not determined by a nation's wealth. Japan is just an exception that might indicate towards the determining factor be it social structure, government policies, climate or geography. Most likely a mix of all these.
